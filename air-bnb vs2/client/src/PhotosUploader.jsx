...
async function addPhotoByLink(event) {
  ...
  try {
    ...
    function selectAsMainPhoto(event,filename){
      event.preventDefault();
        onChange([
          filename,...addedPhotos.filter((photo) => photo !== filename),]);
    }
  return (
    <>
          ...
          addedPhotos.map(link => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 text-white bg-black bg-opacity-50 rounded-2xl p-1 py-2 px-2"
              >
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 left-1 text-white bg-black bg-opacity-50 rounded-2xl p-1 py-2 px-2"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
